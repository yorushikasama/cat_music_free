...
export default function Icon(props: IProps) {
    ...
    // When color is provided, also set fill and stroke explicitly to avoid
    // currentColor resolution failures during theme transitions.
    if (color) {
    ...
    const iconKey = `${name}-${color ?? "default"}`;
