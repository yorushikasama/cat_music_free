...
const outlineOnlyIconNames: Partial<Record<IIconName, true>> = {
...
export default function Icon(props: IProps) {
    ...
    if (color) {
        // Workaround for react-native-svg currentColor bug on New Architecture:
        // Most project icons expect color to drive both fill and stroke.
        // Search icons are outline icons, so keep them hollow.
        if (outlineOnlyIconNames[name]) {
            (newProps as any).fill = "none";
            (newProps as any).stroke = color;
        } else {
            (newProps as any).fill = color;
            (newProps as any).stroke = color;
        }
    }
